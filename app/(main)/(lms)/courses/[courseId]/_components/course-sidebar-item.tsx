  ...
  return (
    <button
      ...
      className={cn(
        ...
        isCompleted && "text-purple-700 hover:text-purple-700 dark:text-purple-400 dark:hover:text-purple-100",
        isCompleted && isActive && "bg-purple-200/20 dark:bg-purple-300/20",
      )}
    >
